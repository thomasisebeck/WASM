...
var Module = typeof adder != 'undefined' ? adder : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_adder')) {
        Object.defineProperty(Module['ready'], '_adder', { configurable: true, get: function() { abort('You are getting _adder on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_adder', { configurable: true, set: function() { abort('You are setting _adder on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'adder_wasm.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('adder_wasm.wasm', import.meta.url).toString();
}
...
/** @type {function(...*):?} */
var _adder = Module["_adder"] = createExportWrapper("adder");
